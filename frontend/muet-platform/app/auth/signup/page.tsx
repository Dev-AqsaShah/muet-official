    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#f0fdf4' }}>
        <div className="text-center">
          <div className="w-20 h-20 rounded-full bg-brand-green/15 flex items-center justify-center mx-auto mb-5">
            <CheckCircle2 size={40} className="text-brand-green" />
          </div>
          <h2 className="text-2xl font-bold text-brand-forest mb-2">Account Created!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20" style={{ background: '#f0fdf4' }}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-brand-forest">Create your account</h1>
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-brand-green/10 border border-gray-100 p-8">
            ...
            <div>
              ...
              <div className="relative">
                <input type={show.confirm ? 'text' : 'password'} required value={form.confirm}
                  ...
                  className={`w-full px-4 py-3 pr-11 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-green/30 transition-all ${
                    form.confirm && form.confirm !== form.password ? 'border-red-300 bg-red-50' : 'border-gray-200 focus:border-brand-green'
                  }`} />
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/auth/signin" className="text-brand-green font-semibold hover:underline">Sign in</Link>
          </p>
        </div>
