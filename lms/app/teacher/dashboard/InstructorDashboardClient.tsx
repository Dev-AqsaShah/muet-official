  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}
        ...
        <QuickLink href="/teacher/mark-attendance" icon={CheckSquare}  label="Mark Attendance" color="#00E5C8" />
        <QuickLink href="/teacher/upload-material" icon={Upload}       label="Upload Material" color="#38BDF8" />
        <QuickLink href="/teacher/create-quiz"     icon={PlusSquare}   label="Create Quiz"     color="#818CF8" />
        <QuickLink href="/teacher/grades"          icon={ClipboardList} label="Grade Work"     color="#FBBF24" />
      </motion.div>
